...
PRODUCT_STYLES: Dict[str, ProductStyle] = {
    ...
    "cr_depth_970": ProductStyle(
        cmap="YlOrRd",
        vmin=0.0,
        vmax=0.25,
        label="CR Depth 970 nm",
        class_ticks=None,
    ),
    "cr_depth_1200": ProductStyle(
        cmap="YlOrRd",
        vmin=0.0,
        vmax=0.20,
        label="CR Depth 1200 nm",
        class_ticks=None,
    ),
    "cr_depth_1700": ProductStyle(
        cmap="YlOrRd",
        vmin=0.0,
        vmax=0.15,
        label="CR Depth 1700 nm",
        class_ticks=None,
    ),
    "cr_depth_2100": ProductStyle(
        cmap="YlOrRd",
        vmin=0.0,
        vmax=0.20,
        label="CR Depth 2100 nm",
        class_ticks=None,
    ),
    "delta_nbr": ProductStyle(
        cmap="RdYlGn",
        vmin=-0.5,
        vmax=0.5,
        label="ΔNBR (Recovery)",
    ...
    "delta_ndvi": ProductStyle(
        cmap="RdYlGn",
        vmin=-0.5,
        vmax=0.5,
        label="ΔNDVI (Recovery)",
        class_ticks=None,
    ),
}
